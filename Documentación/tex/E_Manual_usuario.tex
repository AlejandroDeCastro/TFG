...
\imagen{Pantalla - Registros}{Pantalla de visualización de los registros del usuario}
...
\imagen{Pantalla - Conjunto 1}{Pantalla de visualización de un conjunto de datos en un mapa}
...
\imagen{Pantalla - Conjunto 2}{Pantalla de visualización de un conjunto de datos en una tabla}
