...
Se modeló un diseño de ventanas previo al diseño estético o \textit{front-end} de la aplicaicón para poder analizar el diseño \textbf{\textit{UX}}\footnote{User Experience} y \textbf{\textit{UI}}\footnote{User Interface} de la aplicación, objetivos clave en este proyecto como se ha remarcado en la sección de objetivos\ref{objetivos-generales}. Para ello se utilizó \textbf{Pencil}\footnote{\url{https://pencil.evolus.vn}}, una aplicación de código abierto utilizada para la creación de prototipos y el diseño de interfaces de usuario (\textbf{\textit{UI}}).


\subsection{Lenguajes de programación}

La mayor parte de la aplicación se ha desarrollado con Python, usando Flask, un microframework para desarrollar aplicaciones web.
