...
\begin{table}
	\scalebox{0.80}{
		\begin{tabular}{@{}p{10em} p{6em} p{20em}@{}}
			\toprule
			\textbf{Librería} & \textbf{Versión} & \textbf{Descripción}\\
			\midrule
			\texttt{\textbf{\underline{id}}} & \texttt{\textbf{\underline{PK}}} & Identificador. Generado automáticamente. \\
			\texttt{ciudad} &  \texttt{VARCHAR(25)} & Ciudad en la que se encuentra el conjunto de datos.\\
